...
namespace UseCerebellumRestLib.Services
{
    ...
    {
        Task<IEnumerable<Attachment>> UploadFiles(IMessageSummary messageSummary);
    }
    #endregion
    internal class FileService : IFileService
    {
        ...
        public async Task<IEnumerable<Attachment>> UploadFiles(IMessageSummary messageSummary)
        {
            ...
            foreach (var attachment in messageSummary.Attachments.OfType<BodyPartBasic>())
            {
                ...
                var part = (MimePart) messageSummary;
